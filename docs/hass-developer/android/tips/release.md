...
2. **Build the app**  
   ...
   # OR
   ./gradlew ::assembleRelease # To build a specific module, such as :app, :automotive, or :wear
   ```
   ...
   # OR
   ./gradlew ::bundleRelease # To build a specific module, such as :app, :automotive, or :wear
   ```
