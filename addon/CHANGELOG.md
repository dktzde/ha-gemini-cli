...
- Replaced `claude-code` with `@google/gemini-cli`.
- Updated Dockerfile to install Gemini CLI via npm.
- Updated configuration and entrypoint scripts to use `gemini` executable and environment variables.
- Removed Mistral/Claude specific references.
